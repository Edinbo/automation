...
def generate_nickname():
        name = "snakegiggle"
        return name + str(random.randint(10000, 999999))
...
def registration():
    ...
    with sync_playwright() as pw:
        ...
        page.route('https://apis.roblox.com/universal-app-configuration/v1/behaviors/cookie-policy/content',
                   lambda route: route.abort())  # Blocks cookies banner
        ...
        with open('cookies.txt', 'a') as file:
            ...
            roblosecurity_cookie = next((cookie for cookie in cookies if cookie['name'] == '.ROBLOSECURITY'),
                                        None)
